...
async function loadAllDestinations() {
    ...
    container.innerHTML = '<div class="loading"><i class="fas fa-spinner fa-spin"></i> Loading amazing places...</div>';
    ...
    try {
        ...
        container.innerHTML = '';
        container.innerHTML += '<div class="category-title"><i class="fas fa-landmark"></i> Historical Sites <span class="count">(6 places)</span></div>';
        staticDestinations.historical.forEach(dest => { container.innerHTML += createDestinationCard(dest); });
        container.innerHTML += '<div class="category-title"><i class="fas fa-mountain"></i> Natural Wonders <span class="count">(6 places)</span></div>';
        staticDestinations.natural.forEach(dest => { container.innerHTML += createDestinationCard(dest); });
        container.innerHTML += '<div class="category-title"><i class="fas fa-users"></i> Cultural Experiences <span class="count">(6 places)</span></div>';
        staticDestinations.cultural.forEach(dest => { container.innerHTML += createDestinationCard(dest); });
    }
}
...
const staticDestinations = {
    historical: [
        ...
        },
        {
            ...
            description: "A 6th-century monastery located on a flat-topped mountain. Accessible only by climbing a 15-meter rope.",
            bestTime: "October to March",
    ...
    natural: [
        {
            ...
            description: "UNESCO World Heritage site with dramatic landscapes, deep valleys, and unique wildlife including Gelada baboons and Walia ibex.",
        ...
        },
        {
            ...
            description: "One of the hottest and most alien landscapes on Earth with active volcanoes, colorful sulfur springs, and salt flats.",
            bestTime: "November to February",
        ...
        },
        {
            ...
            description: "Spectacular waterfall on the Blue Nile river, known locally as 'Tis Abay' meaning 'smoking water'.",
        ...
        },
        {
            ...
            description: "Home to the rare Ethiopian wolf and many endemic birds. Features Africa's largest alpine habitat.",
        ...
        },
        {
            ...
            description: "The longest cave system in Ethiopia, stretching over 15 kilometers with unique rock formations.",
            bestTime: "October to March",
        ...
        },
        {
            ...
            description: "Ethiopia's largest lake and the source of the Blue Nile. Home to ancient island monasteries.",
    ...
    cultural: [
        {
            ...
            description: "Home to diverse indigenous tribes with rich cultural traditions, unique ceremonies, and traditional ways of life.",
        ...
        },
        {
            ...
            description: "Ethiopian Epiphany celebration with colorful processions, prayers, and ceremonies.",
        ...
        },
        {
            ...
            description: "One of Africa's largest open-air markets. Experience local trade, spices, traditional crafts.",
        ...
        },
        {
            ...
            description: "Experience the traditional coffee ceremony, an important part of Ethiopian culture.",
            bestTime: "Any time",
        ...
        },
        {
            ...
            description: "Annual religious festival celebrating the finding of the True Cross. Huge bonfires and colorful processions.",
        ...
        },
        {
            ...
            description: "Oromo thanksgiving festival celebrating the end of the rainy season.",
